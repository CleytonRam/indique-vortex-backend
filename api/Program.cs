...
var jwtIssuer = builder.Configuration["Jwt:Issuer"] ?? "ReferralApi";
var jwtAudience = builder.Configuration["Jwt:Audience"] ?? "ReferralApiClient";
...
using (var scope = app.Services.CreateScope())
{
    ...
    catch (Exception ex)
    {
        ...
        logger.LogError(ex, "❌ Ocorreu um erro ao executar o seed data.");
    }
}
